...
def process_image(args, img_raw_path, img_scaled_path, scale_factor):
  ...
  # xbr
  xbr(input_path=img_scaled_path, output_path=img_scaled_path, scale_factor=scale_factor)
...
def xbr(input_path, output_path, scale_factor):
  try:
    arguments = f" -{scale_factor}xBRZ \"{input_path}\" \"{output_path}\""
